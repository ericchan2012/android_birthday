 ...
 * 类说明
 */
public class GetUserProfileClickListener implements OnClickListener {
	private QQLoginActivity mActivity;

	public GetUserProfileClickListener(QQLoginActivity activity) {
		mActivity = activity;
	}
	...
	public void onClick(View v) {
		...
		TencentOpenAPI.userProfile(mActivity.mAccessToken, mActivity.mAppid, mActivity.mOpenId, new Callback() {
...
//						mActivity.showMessage("用户真实信息", obj.toString());
					}
				});
			}
